...
import RulesSurface from './RulesSurface.vue';
...
describe('RulesSurface', () => {
  it('renders without throwing', () => {
    const w = mount(RulesSurface, { props: { scan } });
    expect(w.find('[data-test="rules-surface"]').exists()).toBe(true);
  });
});
